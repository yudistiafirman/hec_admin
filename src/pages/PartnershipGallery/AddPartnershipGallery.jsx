...
import { postPartnershipGallery } from "../../asyncActions/PartnershipGalleryActions";

const AddPartnershipGallery = () => {
	const [
		image,
		status,
		name,
	...
	const postNewPartnershipGallery = async () => {
		try {
			setBackdrop(true);
			...
			const response = await postPartnershipGallery(data);
...
export default AddPartnershipGallery;
