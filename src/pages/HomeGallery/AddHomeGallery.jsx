...
import { postHomeGallery } from "../../asyncActions/HomeGalleryActions";
...
const AddHomeGallery = () => {
	...
	const postNewHomeGallery = async () => {
		try {
			setBackdrop(true);
			...
			const response = await postHomeGallery(data);
